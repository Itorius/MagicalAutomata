...
public class ContainerAuraManipulator extends Container
{
	private TileEntity te;

	public ContainerAuraManipulator(IInventory playerInventory, TileEntity te)
	{
		this.te = te;
	...
	{
		return te instanceof TileEntityVisReplenisher ? ((TileEntityVisReplenisher)te).canInteractWith(playerIn) : ((TileEntityFluxScrubber)te).canInteractWith(playerIn);
	}
}
