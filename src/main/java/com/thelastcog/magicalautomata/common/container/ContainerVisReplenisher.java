...
public class ContainerVisReplenisher extends Container {
    private TileEntityVisReplenisher te;

    public ContainerVisReplenisher(IInventory playerInventory, TileEntityVisReplenisher te) {
        this.te = te;
